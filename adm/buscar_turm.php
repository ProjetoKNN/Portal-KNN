		...
		<?php 
			...
			if(isset($_POST['buscar']))
			{
				...
				{	echo "<tr>";
					...
					echo "<td>";
					echo "<form action='php/remove_turma.php' method='post'>";
					echo "<input name='cod' type='hidden' value='" .$dados['cod']. "'>";
				...
				if( $_GET['remocao'] == "true" ){
					...
					echo "<div class='alert alert-success' role='alert'>Erro ao remover dados! Tente novamente!</div>";
				}
			} 
			...
			if( isset($_GET['alteracao']) ){
				...
				if( $_GET['alteracao'] == "true" ){
					...
					echo "<div class='alert alert-success' role='alert'>Erro na alteração de dados! Tente novamente!</div>";
				}
			} 
			}
		?>
